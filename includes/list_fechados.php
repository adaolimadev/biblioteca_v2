...
<?php 
    ...
    $emprestimos = $empDao->listarAtivos('status = 0',null,null,'cod, nome_cliente, data_emp, obs, status, data_dev  ');
...
<main>
    <div class="container">
    <section>
    <h1 class="text-center mt-2">EMPRÉSTIMOS FECHADOS</h1>
        <div class="col ">
